...
sel <- sel[data.table(Dmel= c("14.mip120_Unknown6", "8.Hsf", "23.Ohler6", "11.HLH3B_ac_da_Fer1_da_ac_da_ase"),
...
pdf("pdf/peSTARRSeq/examples_lm_motifs_LR.pdf", 14, 5.5)
...
dev.off()
file.show("pdf/peSTARRSeq/examples_lm_motifs_LR.pdf")
