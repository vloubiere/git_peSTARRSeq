...
STARR <- readRDS("../pe_STARRSeq/Rdata/processed_peSTARRSeq_data/DESeq2_FC_table.rds")
coll[STARR, log2FoldChange:= i.log2FoldChange, on= c("L==enh_L", "R==enh_R")]
...
pdf("pdf/PCC_stripchart_luc_validations_peSTARRSeq.pdf", 4.5, 5)
# PCC
par(las= 1)
plot(NA, 
