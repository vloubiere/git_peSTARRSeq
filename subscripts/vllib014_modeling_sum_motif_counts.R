...
all <- fread("db/final_tables_exp_model/vllib014_short_spacer_peSTARRSeq_max_cutoff_final_oe.txt")
...
fwrite(dat, "Rdata/vllib014_modelling_sum_motif_counts.txt")
...
pdf("pdf/modeling/vllib014_modeling_sum_motif_counts.pdf", 
    width = 15.5, 
    height = 8.5)
