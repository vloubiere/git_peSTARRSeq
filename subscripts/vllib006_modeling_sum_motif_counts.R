...
all <- fread("db/final_tables_exp_model/vllib006_long_spacer_peSTARRSeq_low_cutoff_final_oe.txt")
...
fwrite(dat, "Rdata/vllib006_modelling_sum_motif_counts.txt")
...
pdf("pdf/modeling/vllib006_modeling_sum_motif_counts.pdf", 
    width = 15.5, 
    height = 8.5)
