...
plot(log2(dat[["no_enh_Rep1"]]+1), log2(dat[["zfh1_enh_avg"]]+1), 
     ...
     pch= 19)
text(log2(dat[sel_dev][["no_enh_Rep1"]]+1), 
     log2(dat[sel_dev][["zfh1_enh_avg"]]+1),
     ifelse(log2(dat[sel_dev][["zfh1_enh_avg"]]+1)-log2(dat[sel_dev][["no_enh_Rep1"]]+1)>3.5, "inducible", "not_inducible"),
     cex= 0.5, 
     pos= 4)
...
plot(log2(dat[["no_enh_Rep1"]]+1), log2(dat[["ssp3_enh_Rep1"]]+1), 
     ...
     pch= 19)
text(log2(dat[sel_hk][["no_enh_Rep1"]]+1), 
     log2(dat[sel_hk][["ssp3_enh_Rep1"]]+1))

dev <- dat[sel_dev]
dev[, detail:= ifelse(log2(dat[sel_dev][["zfh1_enh_avg"]]+1)-log2(dat[sel_dev][["no_enh_Rep1"]]+1)>3.5, "dev_inducible", "not_inducible")]
hk <- dat[sel_hk]
