...
# Merge lego and idr db data ----
dat <- merge(LEGO,
             idr,
             by= "FBgn")

# Define Housekeepig/dev classes ----
...
# Select TFs/COFs expressed in S2 cells ----
...
pdf("pdf/draft/hk_dev_TFs_COFs_IDR_content.pdf",
    width = 9, 
    height= 3)
