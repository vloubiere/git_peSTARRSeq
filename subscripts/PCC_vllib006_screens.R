...
if(!exists("dat"))
{
  dat <- list(old= "db/umi_counts//vllib006_rev-pe-STARR-Seq_DSCP_T8_revSPA1_2000_775_T_screen_vllib011_0.1_scale-up-2_rep1__HVK7KBGXH_1_20210512B_20210513.txt",
              new_r1= "db/merged_counts//vllib006_rev-pe-STARR-Seq_DSCP_T8_revSPA1_2000_screen_rep1_merged.txt",
              new_r2= "db/merged_counts//vllib006_rev-pe-STARR-Seq_DSCP_T8_revSPA1_2000_screen_rep2_merged.txt")
...
pdf("pdf/alignment/PCC_40x_20x_2ndStrand_revSTARRSeq_screens.pdf")
